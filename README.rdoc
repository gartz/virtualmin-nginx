...
Virtualmin has added official support for nginx: http://www.virtualmin.com/documentation/web/nginx
...
https://github.com/downloads/lewellyn/virtualmin-nginx/lewellyn-virtualmin-nginx-current.wbm.gz
into the box.
...
The permissions must be _root_.
